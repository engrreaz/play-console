...
<main class="pb-5 mt-1">
    <div class="student-hero">
        ...
        <div class="st-meta">
            Class <?php echo $cls; ?> <i class="bi bi-dot"></i> Section <?php echo $sec; ?> <i class="bi bi-dot"></i>
            Roll <?php echo $rollno; ?>
        </div>
    </div>

    <div class="action-grid" id="main-data">
        ...
        <a href="stguarmore.php?stid=<?php echo $userid; ?>&year=<?php echo $current_session; ?>"
            class="m3-tonal-card shadow-sm">
    ...
    <div class="px-3 mb-2 d-flex justify-content-between align-items-center">
        ...
        <?php if (!empty($student_dashboard_data['daily_tasks'])): ?>
            <span class="badge bg-primary-subtle text-primary rounded-pill px-2"
                style="font-size: 0.6rem;"><?php echo count($student_dashboard_data['daily_tasks']); ?> ACTIVE</span>
        <?php endif; ?>
    </div>
