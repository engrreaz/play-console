...
<div class="container">
    <div style="max-width:900px;margin:auto;padding:20px;font-family:Arial;line-height:1.7;color:#222;">
        ...
        <p>
            This Account Deletion Policy explains how users of the EIMBox School Management System can request deletion
            of their account and associated data.
        </p>

        <p>
            This service is operated by <strong>“EIMBox”</strong> for registered educational institutions
            including schools, colleges, and madrasas.
        </p>
        ...
        <p>
            Only authorized users (students, teachers, guardians, or institution staff) who are part of a registered
            institution can request account deletion.
        </p>
        ...
        <p>
            <a class="btn btn-link text-danger" href="https://playconsole.eimbox.com/delete-my-account.php" target="_blank">
        ...
        <p>
            After a deletion request is approved, data may be retained temporarily for backup purposes for up to
        ...
        <h2>8. Security</h2>
        <p>
            All deletion requests are processed securely through HTTPS encrypted communication to ensure data
            protection.
        </p>
