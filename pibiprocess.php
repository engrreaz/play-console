...
<body style="background:var(--lighter); min-height:100vh;">
  <header>
    <!-- place navbar here -->
  </header>
  <main>
        ...
        <div class="card text-left" style="background:var(--dark); color:var(--lighter);"  >
            ...
            <div class="card-body">
                <table width="100%" style="color:white;">
                    <tr>
                        <td>
                            <div class="logoo"><i class="bi bi-upc-scan"></i></div>
                            <div style="font-size:20px; text-align:center; padding: 2px 2px 8px; font-weight:500; line-height:22px;">
                                Marks & Assessment<br>Entry Scanner
                            </div>
                        </td>
                    </tr>
                </table>
    ...
    <?php  if($userlevel == 'Administrator' || $userlevel == 'Head Teacher'){ ?>
            ...
            <div class="card" style="background:graylighter; color:var(--darker);" onclick="lnk1();" >
                ...
                <table style="width:100%">
                        ...
                        <td>
                            <div style="text-align:left; padding-top:0px; ">
                                <div class="input-group">
                                    <span class="input-group-text" style="background:lightgray;"><i class="material-icons ico">group</i></span>
                                    <input type="text" id="exam" name="exam" class="form-control" placeholder="Exam Name"  value="<?php echo $exam;?>" disabled >
                                </div>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            ...
                            <div class="form-group input-group">
                                <span class="input-group-text"><i class="material-icons ico">group</i></span>
                                <select class="form-control sele" id="cls" <?php if($cid>0){echo 'disabled';} ?>>
                    ...
                    <tr>
                        <td colspan="2" >
                            ...
                            <button  class="btn btn-danger" onclick="merge(0,3);" id="rst">Reset</button><div id="put"></div>
                        </td>
                    </tr>
                </table>
                <span style="">To get a perfect report, please mark down the absent / drop out students from <a href="classsection.php">Students List</a>.</span>
              </div>
            </div>
  ...
  <script>
      function submit(tail) {
		...
		var infor="rootuser=<?php echo $rootuser;?>&id=" + id + "&sccode=<?php echo $sccode;?>&usr=<?php echo $usr;?>&exam=" + exam + "&tail="+ tail;
	$("#block").html( "" );
