...
<style>
    :root { --m3-surface: #F7F2FA; --m3-primary: #6750A4; --m3-primary-tonal: #EADDFF; }
    ...
    .pill { border: none; padding: 8px 18px; border-radius: 50px; font-weight: 700; font-size: .7rem; background: rgba(255,255,255,0.2); color: #fff; cursor: pointer; transition: 0.3s; }
    .pill.active { background: #fff; color: #6750A4; }

    /* কার্ড ডিজাইন */
    .perm-card { background: #FFFFFF; border-radius: 12px; padding: 16px; margin: 12px 16px; display: flex; align-items: center; gap: 15px; border: 1px solid #E0E0E0; cursor: pointer; transition: 0.2s; }
    .perm-card:active { transform: scale(0.97); background: #F3EDF7; }
    .perm-card.unassigned { border-left: 5px solid #F9DEDC; }
    .perm-card.mapped { border-left: 5px solid #E8F5E9; }

    .icon-box-m3 { width: 48px; height: 48px; border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 1.4rem; flex-shrink: 0; }
    .c-mapped { background-color: #EADDFF; color: #21005D; }
    .c-unassigned { background-color: #F9DEDC; color: #410E0B; }

    .file-name { font-size: 0.9rem; font-weight: 800; color: #1C1B1F; margin-bottom: 2px; }
    .file-title { font-size: 0.75rem; font-weight: 600; color: #49454F; }
    .module-label { font-size: 0.65rem; font-weight: 500; color: #79747E; }
    ...
    .role-row select { background: #6750A4; color: white; border: none; border-radius: 20px; padding: 4px 10px; font-size: 0.75rem; font-weight: 700; outline:none; }
    
    #loader { text-align: center; padding: 30px; font-weight: bold; color: #6750A4; }
</style>
...
<main>
    ...
    <div id="loader"><div class="spinner-border spinner-border-sm me-2"></div> Loading Data...</div>
        ...
        <div class="modal-content m3-modal-content shadow-lg">
            ...
            <form id="saveForm" method="post" action="">
                <div class="modal-body" style="max-height: 60vh; overflow-y: auto;">
                    ...
                    <input type="text" name="page_title" id="m_title" class="m3-input-floating" placeholder="Page Title">
                    ...
                    <div style="font-size: 0.75rem; font-weight: 800; color: #6750A4; margin: 15px 5px 10px;">ROLE PERMISSIONS</div>
                    <div id="roleFields"></div>
                </div>
                <div class="modal-footer border-0">
                    <button type="button" class="btn btn-light rounded-pill flex-fill fw-bold" data-bs-dismiss="modal">CLOSE</button>
                    <button type="submit" name="save_all_permissions" class="btn btn-primary rounded-pill flex-fill fw-bold shadow">SAVE</button>
                </div>
            </form>
        </div>
    </div>
