...
<body>
  ...
  <main>
    <div class="container-fluidx">
        <div class="card text-left" style="background:var(--dark); color:var(--lighter);"  onclick="goj(<?php echo $id;?>)">
          
            <div class="card-body">
                <table width="100%" style="color:white;">
                    <tr>
                        <td>
                            <div class="logoo"><i class="bi bi-door-open-fill"></i></div>
    ...
    <?php  if($userlevel == 'Administrator' || $userlevel == 'Head Teacher'){ ?>
            <div class="card" style="background:var(--lighter); color:var(--darker);" onclick="lnk10();" >
              ...
              <div class="card-body">
                <table style="">
                    <tr>
                        ...
                        <td>
                            <h4>Class Routine</h4>
                            <small>Setup Class Routine</small>
                        </td>
                    </tr>
                </table>
              </div>
                ...
                <table style="">
                    <tr>
                        ...
                        <td>
                            ...
                            <small>Managing your total exam system</small>
                        </td>
                    </tr>
                </table>
              </div>
            ...
            <div class="card" style="background:var(--lighter); color:var(--darker);" onclick="lnk52();" >
              <img class="card-img-top"  alt="">
              <div class="card-body">
                <table style="">
                    <tr>
            ...
            <div class="card" style="background:var(--lighter); color:var(--darker);" onclick="lnk12();" >
              <img class="card-img-top"  alt="">
              <div class="card-body">
                <table style="">
                    <tr>
                        ...
                        <td>
                            <h4>Promotion</h4>
                            <small>Promotion Management System</small>
                        </td>
                    </tr>
                </table>
              </div>
            ...
            <div class="card" style="background:var(--lighter); color:var(--darker);" onclick="lnk18();" >
              <img class="card-img-top"  alt="">
              <div class="card-body">
                <table style="">
                    <tr>
                        ...
                        <td>
                            <h4>Admission</h4>
                            <small>Admission New Student (New Session)</small>
                        </td>
                    </tr>
                </table>
              </div>
  ...
  document.getElementById("cnt").innerHTML = "<?php echo $cnt;?>";
    ...
    function go(){
        ...
        function lnk18(){ window.location.href="studentadmission.php"; }
        function lnk52(){ window.location.href="cashbookview.php"; }
        function lnk10(){ window.location.href="clsroutine.php"; }
        function lnk12(){ window.location.href="promotion.php"; }
