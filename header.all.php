...
<body>
    ...
    <header class="m3-app-bar" style="z-index: 25999;;">
        ...
        <div class="rounded-circle overflow-hidden border top-avatar shadow-sm avatar-ring-green"
            style="width:34px;height:34px;cursor:pointer;z-index:25999;" >

            <img src="iimg/logo.png" style="width:100%;border-radius:50%;">
