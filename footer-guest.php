...
<div id="bottom-nav-bar" class="bottom-nav-container noprint">
    <div class="bottom-nav">
        <a href="index_guest.php" class="nav-item text-primary <?= isActive('index_guest.php', $curfile) ?>" data-action="Navigation">
            <div class="icon-wrapper"><i class="bi bi-house-fill"></i></div>
            <span>Home</span>
        </a>
        <a href="notices-guest.php" class="nav-item text-warning <?= isActive('notices-guest.php', $curfile) ?>">
            <div class="icon-wrapper"><i class="bi bi-file-earmark-lock"></i></div>
            <span>Notice</span>
        </a>
        <a href="calendar-guest.php" class="nav-item text-secondary <?= isActive('calendar-guest.php', $curfile) ?>">
            <div class="icon-wrapper"><i class="bi bi-journal-text"></i></div>
            <span>Calendar</span>
        </a>
        <a href="teachers-list-guest.php" class="nav-item text-info <?= isActive('teachers-list-guest.php', $curfile) ?>">
            <div class="icon-wrapper"><i class="bi bi-journal-text"></i></div>
            <span>Teachers</span>
        </a>
        <a href="logout.php" class="nav-item  text-danger <?= isActive('logout.php', $curfile) ?>">
