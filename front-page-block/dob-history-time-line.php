...
if (!empty($students_with_birthday_today)):
    ...
    <style>
        ...
        .m3-scroll-container::-webkit-scrollbar {
            display: none;
        }
    ...
    <div class="m3-birthday-card shadow-sm">
        <div class="m3-card-header">
            ...
            <div>
                ...
                <div class="small opacity-75" style="font-size: 0.7rem;">Celebrating
                    <?php echo count($students_with_birthday_today); ?> students
                </div>
            </div>
        </div>
        ...
        <div class="m3-scroll-container">
            <?php foreach ($students_with_birthday_today as $student):
                ...
                <div class="m3-birthday-item">
                    <a href="student-my-profile.php?stid=<?php echo htmlspecialchars($student['stid']); ?>"
                        class="text-decoration-none">
                        <div class="m3-avatar-wrapper">
                            <div class="m3-celebration-ring"></div>
                            <img src="<?php echo $photo_path; ?>" class="m3-avatar-img" alt="Student">
                        </div>
    ...
    <div class="alert alert-info mb-0">
        <i class="bi bi-info-circle-fill"></i> No students have birthdays today.
    </div>
    <?php
endif;
