...
<body>
  ...
  <main>
    <div class="container-fluidx">
        ...
        <div class="card text-left" style="background:var(--dark); color:var(--lighter);"  onclick="god(<?php echo $id;?>)">
          
            <div class="card-body">
                <table width="100%" style="color:white;">
                    <tr>
                        <td>
                            <div class="logoo"><i class="bi bi-file-text-fill"></i></div>
                            <div style="font-size:20px; text-align:center; padding: 2px 2px 8px; font-weight:700; line-height:15px;">Transcript
            ...
            <div class="card" style="background:var(<?php echo $bgc;?>); color:var(--darker);"  >
              <div class="card-body">
                <div class="form-group">
                    <label for="exampleFormControlSelect1">Manage Transcript</label>
                    <select class="form-control" id="result">
                      <option value=""></option>
                      <option value="class" Selected>Class Based (All Subject, All Student)</option>
                      <option value="subject" >Subject Based (All Student)</option>
                      <option value="student">Student Based (All Subjects)</option>
                    </select>
                  </div>
              </div>
            </div>
              ...
              <div class="card-body" id="subblock">
                <div class="form-group">
                    ...
                    <select class="form-control" id="subject">
                      <option></option>
                            <?php
                            $sql0 = "SELECT subject FROM subsetup where sccode='$sccode' and classname='$cls' and sectionname='$sec'  order by subject";
              ...
              <div class="card-body">
                <div class="form-group">
                    ...
                    <select class="form-control" id="assessment">
                      <option value="Total Assessment" selected>Performance Assessment (PI)</option>
            ...
            <center>
                <br>
                <button class="btn btn-primary pad60"  style="margin:0 0 10px 0; color:white;" onclick="go();">Show Transcript</button>
            </center>
  ...
  document.getElementById("cnt").innerHTML = "<?php echo $cnt;?>";
    ...
    function go(){
        ...
        let tail = '?exam=' + exam + '&cls=' + cls + '&sec=' + sec + '&sub=' + sub + '&assess=' + assess + '&design=' + design + '&result=' + result + "&token=<?php echo $token;?>"; 
        if(cls=='Six'|| cls == 'Seven'){
            window.location.href="transcript.php" + tail; 
        } else {
            window.location.href="transcript.php" + tail; 
        }
    }  
