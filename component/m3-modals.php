        ...
        <div class="modal-content" style="border-radius: 8px; border: none;">
            ...
            <div class="modal-body pt-2">
                ...
                <div class="form-floating mb-2">
                    <input type="number" class="form-control" id="spltamt" placeholder="Amount"
            ...
            <div class="modal-footer border-0 pt-0">
                ...
                <button type="button" class="btn btn-primary" id="mybtn" onclick="splitable();"
                    style="border-radius: 8px; font-weight: 700;">Split Now</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content" style="border-radius: 8px; border: none;">
            ...
            <div class="modal-body pt-2">
                <div class="form-floating mb-3">
                    <input type="number" class="form-control text-danger fw-bold" id="fine_amount" placeholder="Amount"
                        style="border-radius: 8px; font-size: 1.2rem;">
                    <label for="fine_amount">Fine Amount (BDT)</label>
                </div>
                <div class="form-floating" hidden>
                    <textarea class="form-control" id="fine_note" placeholder="Note"
                        style="height: 100px; border-radius: 8px;"></textarea>
            ...
            <div class="modal-footer border-0 pt-0">
                ...
                <button type="button" class="btn btn-warning fw-bold shadow-sm" onclick="saveFine();"
                    style="border-radius: 8px;">Add Fine</button>
            </div>
        </div>
    </div>
</div>