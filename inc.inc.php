...
$blocks = [
    ...
    'birthday' => ['title' => 'Birthday Greetings', 'icon' => 'bi-balloon-heart-fill', 'link' => 'dob-history-time-line.php', 'role' => 'Super Administrator | Chief | Administrator | Teacher '],
    'Calendar' => ['title' => 'Events Calendar', 'icon' => 'bi-calendar-event-fill', 'link' => 'events-calendar.php', 'role' => 'Super Administrator  | Chief | Administrator | Teacher | Student | Guardian | Guest '],
    'events' => ['title' => 'History', 'icon' => 'bi-calendar-event-fill', 'link' => 'events-block.php', 'role' => 'Super Administrator  | Chief | Administrator | Teacher | Student | Guardian | Guest '],
    'schedule' => ['title' => 'Class Routine', 'icon' => 'bi-calendar3', 'link' => 'schedule.php', 'role' => 'Super Administrator  | Chief | Administrator | Teacher | Student | Guardian | Guest '],
    'notice' => ['title' => 'Notice Board', 'icon' => 'bi-megaphone-fill', 'link' => 'notice.php', 'role' => 'Super Administrator  | Chief | Administrator | Teacher | Student | Guardian | Guest '],
    'task-teacher' => ['title' => 'Academic Tasks', 'icon' => 'bi-check2-square', 'link' => 'task-teacher.php', 'role' => 'Super Administrator  | Chief | Administrator | Teacher'],
    'cashmanager' => ['title' => 'Cash Manager', 'icon' => 'bi-wallet2', 'link' => 'cashmanager.php', 'role' => 'Super Administrator  | Chief | Administrator | Accountants'],
    'st-payment-block' => ['title' => 'Accounts & Fees', 'icon' => 'bi-cash-coin', 'link' => 'st-payment-block.php', 'role' => 'Super Administrator  | Chief | Administrator | Teacher | Accountants'],
    'class-teacher-block' => ['title' => 'Class Teacher', 'icon' => 'bi-coin', 'link' => 'clsteacherblock.php', 'role' => 'Super Administrator  | Teacher '],
