...
<style>
    ...
    .hero-timer-banner {
        ...
        color: #21005D;
        padding: 28px 24px;
        border-radius: 0 0 24px 24px; /* Material 3 Medium Top Bar End Curve */
    ...
    .st-avatar-squircle { 
        width: 64px; 
        height: 64px; 
        border-radius: 18px; /* M3 Squircle Metric */
        object-fit: cover; 
        ...
        ?>
            ...
            <div class="st-flat-row-item">
                <div class="d-flex align-items-center">
                    <img src="https://eimbox.com/students/<?php echo $stdid; ?>.jpg" class="st-avatar-squircle" onerror="this.src='https://eimbox.com/students/noimg.jpg'">
